...
class App {
    boot() {
        let integrityFail = this.bootFail.bind(this);
        let integrityOk = this.goodToGo.bind(this);
    ...
    goodToGo() {
        fetch('https://api.netflix.com/catalog/titles/movies/261909').then(response =>{
